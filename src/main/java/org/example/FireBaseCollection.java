...
//
//                    // Pass doubles as strings to Total (assuming Total constructor expects strings)
//                    Total t = new Total(
...
//
//
//    boolean isDuplicate(String idNumber, String day, String month, String year) {
//        try {
...
//            return !querySnapshot.isEmpty(); // true if duplicate exists
//        } catch (InterruptedException | ExecutionException e) {
//            e.printStackTrace();
...
////    }
//
////    public void search(int index, ArrayList<String> Score){
////        if(index >=0 && index<formGui.tablee.person.size()){
...
////
////                        ApiFuture<com.google.cloud.firestore.WriteResult> editp = personsCollect.document(document.getId()).update(person);
////                        editp.get();
////
////                        //personToEdit.setFirst(FN);
////                        personToEdit.setLast(String.valueOf(Score));
